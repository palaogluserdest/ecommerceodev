<head>
    ...
    <!-- Bootstrap style -->
    <link id="callCss" rel="stylesheet" href="{{asset('front/bootshop/bootstrap.min.css')}}" media="screen"/>
    ...
    <link href="{{asset('front/css/font-awesome.cs')}}'" rel="stylesheet" type="text/css">
