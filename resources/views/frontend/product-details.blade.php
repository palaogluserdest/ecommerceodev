    ...
    <div class="span9">
        ...
        <div class="row">
            <div id="gallery" class="span3">
                <a href="{{asset('front/images/products/large/f1.jpg')}}" title="Fujifilm FinePix S2950 Digital Camera">
                    <img src="{{asset('front/images/products/large/3.jpg')}}" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
                </a>
                <div id="differentview" class="moreOptopm carousel slide">
                    <div class="carousel-inner">
                        <div class="item active">
                            <a href="{{asset('front/images/products/large/f1.jpg')}}"> <img style="width:29%" src="{{asset('front/images/products/large/f1.jpg')}}" alt=""/></a>
                            <a href="{{asset('front/images/products/large/f2.jpg')}}"> <img style="width:29%" src="{{asset('front/images/products/large/f2.jpg')}}" alt=""/></a>
                            <a href="{{asset('front/images/products/large/f3.jpg')}}" > <img style="width:29%" src="{{asset('front/images/products/large/f3.jpg')}}" alt=""/></a>
                        </div>
                        <div class="item">
                            <a href="{{asset('front/images/products/large/f3.jpg')}}" > <img style="width:29%" src="{{asset('front/images/products/large/f3.jpg')}}" alt=""/></a>
                            <a href="{{asset('front/images/products/large/f1.jpg')}}"> <img style="width:29%" src="{{asset('front/images/products/large/f1.jpg')}}" alt=""/></a>
